...
const Dashboard = () => (
  <div>
  <main>
    <section className="action-bar content-wrapper"><a className="btn w-button" href="art-order.html">NEW&nbsp;Art Order</a><a className="btn w-button" href="audio-video-order.html">NEW AUDIO/VIDEO Order</a></section>
  </main>
  <main>
